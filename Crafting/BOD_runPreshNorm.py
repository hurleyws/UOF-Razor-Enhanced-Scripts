...
Journal.Clear()
Player.HeadMessage(64,"Running precious normals in 90 seconds")
Misc.Pause(90000)       
worldSave()
...
Misc.Pause(500)
bodbox = Items.FindBySerial(0x4236967A)
...
if myingots:
    ...
    Misc.Pause(1000)
worldSave()
Misc.ScriptRun("BOD_demigod_nonexceptionalPreciousMetals.py")

while Misc.ScriptStatus("BOD_demigod_nonexceptionalPreciousMetals.py"):
    Misc.Pause(10000)
