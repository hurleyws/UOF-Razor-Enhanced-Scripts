...
class BodContract:
    ...
    def needPushedAmount(self):
        if self.__pushedamountidx == 0:  # If its 0 means its the first value and it needs an amount
            return True
